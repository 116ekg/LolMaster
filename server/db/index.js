...
Champion.sync({force: true})
  .then(function() {
    ...
    return Champion.bulkCreate([
      ...
      {name: 'Kennen', champId: 85, icon: '/LOLicons/KennenSquare.png', splash: '/Wallpapers/Kennen.jpg'},
      ...
      {name: 'Viktor', champId: 112, icon: '/LOLicons/ViktorSquare.png', splash: '/Wallpapers/Viktor.jpg'},
